...
def parse_args(args):
    ...
    parser.add_argument(
        "--train-data",
        type=str,
        default="/data/csv/llm2clip/nips/mimic_train.csv",
    ...
    parser.add_argument(
        "--val-data",
        type=str,
        default="/data/csv/llm2clip/nips/mimic_valid.csv",
        help="Path to csv file with validation data",
    )
    parser.add_argument(
        "--chexpertplus",
        type=str,
        default="/data/csv/llm2clip/chexpert_clip_val.csv",
    ...
    parser.add_argument("--text-lr", type=float, default=1e-5, help="Learning rate of text encoder.")
    parser.add_argument("--visual-lr", type=float, default=1e-5, help="Learning rate of visual encoder.")
    ...
    parser.add_argument("--text-wd", type=float, default=0.05, help="Weight decay of text encoder.")
    parser.add_argument("--visual-wd", type=float, default=0.05, help="Weight decay of visual encoder.")

    parser.add_argument("--ld", type=float, default=1.0, help="Learning rate Layer decay.")
    parser.add_argument("--text-ld", type=float, default=1.01, help="Learning rate Layer decay of text encoder.")
    parser.add_argument("--visual-ld", type=float, default=0.85, help="Learning rate Layer decay of visual encoder.")
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to the zeroshot data."
    )
    parser.add_argument(
        "--llm2vec-path",
        type=str,
        default="/model/llm2clip/llm2vec/8b_special/supervised/checkpoint-12535/",
        help="Path to the separate text encoder model."
    )
    parser.add_argument(
        "--text-base",
        type=str,
        default="/model/llm2clip/llm2vec/1b_full/mntp2/checkpoint-5997/",
        help="Path to the separate text encoder model."
    )
    parser.add_argument(
        '--skip-list',
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Gradient accumulation steps; only support  now."
    )
    parser.add_argument(
        "--lock-text",
        default=False,
    ...
    parser.add_argument(
        "--model-pth",
        type=str,
        default="/model/llm2clip/llm2vec/1b_full/supervised3_more/checkpoint-12000/pytorch_model.bin",
